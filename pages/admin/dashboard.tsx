                    ...
                    <div className="max-w-6xl mx-auto mt-9">
                                            ...
                                            {({active}) => (
                                                <a className={`flex items-center my-2 py-2 px-3 ${active && 'bg-blue-500 rounded-lg text-white'}`}
                                                   href="/profile">
                                                    ...
                                                    <div className="font-semibold ml-3">Profile</div>
                                                </a>
                                            )}
                                        </Menu.Item>
                                        <Menu.Item>
                                            {({active}) => (
                                                <a className={`flex items-center my-2 py-2 px-3 ${active && 'bg-blue-500 rounded-lg text-white'}`}
                                                   href="/profile">
                                                    ...
                                                    <div className="font-semibold ml-3">Setting</div>
                                                </a>
                                            )}
                                        </Menu.Item>
                                        <Menu.Item>
                                            {({active}) => (
                                                <Link href={"/login"}>
                                                    <a className={`flex items-center my-2 py-2 px-3 ${active && 'bg-blue-500 rounded-lg text-white'}`}>
                                                        ...
                                                        <div className="font-semibold ml-3">Logout</div>
                                                    </a>
                                                </Link>
                                            )}
                                        </Menu.Item>
                        ...
                        <div className="grid grid-cols-4 gap-x-6">
                            <div className="bg-white rounded-2xl p-6">
                                <h3 className="font-semibold text-5xl text-blue-500">30</h3>
                                <p className="mt-2 font-semibold text-gray-600">Teachers</p>
                            </div>

                            <div className="bg-white rounded-2xl p-6">
                                <h3 className="font-semibold text-5xl text-blue-500">30</h3>
                                <p className="mt-2 font-semibold text-gray-600">Students</p>
                            </div>
                        </div>
                    </div>
                </div>
