                        ...
                        <tr key={course.id}>
                            ...
                            <td className="px-6 py-4 flex justify-center items-center">
                                <Link href={`/teacher/enrollments/${course.id}`}>
                                    <a className="border border-transparent rounded-xl text-sm text-white px-4 py-2 bg-pink-500 mr-1.5 hover:bg-pink-700 focus:ring focus:ring-pink-200">
                                        Enrolments
                                    </a>
                                </Link>
                                <Link href={`/teacher/attendances/${course.id}`}>
                                    <a className="border border-transparent rounded-xl text-sm text-white px-4 py-2 bg-green-500 mx-1.5 hover:bg-green-700 focus:ring focus:ring-green-200">
                                        Attendance
                                    </a>
                                </Link>
                                <button
...
// @ts-ignore
Courses.getLayout = (page: any) => <TeacherLayout>{page}</TeacherLayout>;
