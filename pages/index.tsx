                ...
                <form className="mt-6">
                    <div className="mb-5">
                        <input
                            ...
                            className={`${emailEmpty ? 'border-2 border-red-500' : ''} focus:outline-none block w-full bg-gray-100 font-medium py-2.5 px-4 rounded-2xl placeholder-gray-500`}
                            aria-label="email"
                            placeholder="Username or email"
                        />
                        {emailEmpty ? <p className="text-red-500 text-xs mt-2 ml-4">Please enter your email</p> : ''}
                    </div>
                    <div className="mb-5">
                        <input
                            onChange={(e) => setPassword(e.target.value)}
                            type="password"
                            className={`${passwordEmpty ? 'border-2 border-red-500' : ''} focus:outline-none block w-full bg-gray-100 font-medium py-2.5 px-4 rounded-2xl placeholder-gray-500`}
                            aria-label="password"
