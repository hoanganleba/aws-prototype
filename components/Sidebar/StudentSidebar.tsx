...
const StudentSidebar = () => {
    ...
    return (
        <div className="bg-white h-full w-56">
            ...
            <Link href="/student">
                <a className={`${router.pathname == "/student" ? "border-l-4 border-blue-500" : ""} flex py-1 px-6 my-4`}>
            ...
            <Link href="/student/course">
                <a className={`${router.pathname == "/student/course" ? "border-l-4 border-blue-500" : ""} flex py-1 px-6 my-4`}>
            ...
            <Link href="/student/chat">
                <a className={`${router.pathname == "/student/chat" ? "border-l-4 border-blue-500" : ""} flex py-1 px-6 my-4`}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-blue-500" fill="none"
                         viewBox="0 0 24 24"
                         stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"
