    ...
    return (
        <div className="bg-white h-full w-56 flex-shrink-0">
            ...
            <Link href={"/student/course"}>
                <a className={`${router.pathname == "/student/course" ? "border-l-4 border-blue-500" : ""} text-blue-600 flex py-1 px-6 my-4`}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <Link href={"/student/chat"}>
                <a className={`${router.pathname == "/student/chat" ? "border-l-4 border-blue-500" : ""} text-blue-600 flex py-1 px-6 my-4`}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
